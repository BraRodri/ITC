<!-- Modal -->
<div class="modal" id="modal_nuevo_pago" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body p-4">
                ...
                <form id="form_nuevo_pago" class="row g-3 needs-validation" method="POST" novalidate enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="fecha" name="fecha" value="{{ date('Y-m-d H:m:s a') }}" required readonly>
                    </div>
                    <div class="col-md-12">
                    ...
                    <input type="hidden" name="factura_id" id="modal_pagos_factura_id">
