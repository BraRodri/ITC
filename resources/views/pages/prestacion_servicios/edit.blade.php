        ...
        <div class="mb-4 mt-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('prestacion.servicios.index') }}">Pagos Prestación de Servicios</a></li>
            ...
            <div class="card-body">
                <form id="form_editar" class="row g-3 needs-validation" method="POST" novalidate enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" name="fecha_emision" id="fecha_emision" value="{{ $pago->fecha_emision }}" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" name="observaciones" id="observaciones" rows="4">{{ $pago->observaciones }}</textarea>
                    </div>

                    <input type="hidden" name="id" id="editar_id" value="{{ $pago->id }}">

                    <div class="col-12 pt-3">
                        <a href="{{ route('prestacion.servicios.index') }}" class="btn btn-dark btn-sm">Regresar</a>
        ...
        <script>
            ...
            $('#form_editar').on('submit', function(e) {
                ...
                if ($('#form_editar')[0].checkValidity() === false) {
                    ...
                    var url = route('prestacion.servicios.update');
                    ...
                    $.ajax({
                        ...
                        if (!respuesta.error) {
                            ...
                            location.href = route('prestacion.servicios.index');
                        } else {
                            setTimeout(function(){
                                Swal.fire({
                                    title: "Se presento un error!",
